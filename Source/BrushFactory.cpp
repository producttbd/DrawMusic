...
OwnedArray<PixelBrush> BrushFactory::getAllBrushes()
{
    ...
    brushPattern.add(BrushPoint(-1, -1, 0.1, PointType::Absolute));
    brushPattern.add(BrushPoint(-1, 0, 0.1, PointType::Absolute));
    brushPattern.add(BrushPoint(-1, 1, 0.1, PointType::Absolute));
    brushPattern.add(BrushPoint(0, 1, 0.1, PointType::Absolute));
    brushPattern.add(BrushPoint(1, 1, 0.1, PointType::Absolute));
    brushPattern.add(BrushPoint(1, 0, 0.1, PointType::Absolute));
    brushPattern.add(BrushPoint(1, -1, 0.1, PointType::Absolute));
    brushPattern.add(BrushPoint(0, -1, 0.1, PointType::Absolute));
    brushPattern.add(BrushPoint(0, 0, 0.1, PointType::Absolute));
    result.add(new PixelBrush(TRANS("Square pencil"), brushPattern));

    brushPattern.clear();

    brushPattern.add(BrushPoint(0, 0, 0.1, PointType::Absolute));
    brushPattern.add(BrushPoint(-1, -1, 0.025, PointType::Absolute));
    brushPattern.add(BrushPoint(-1, 0, 0.05, PointType::Absolute));
    brushPattern.add(BrushPoint(-1, 1, 0.025, PointType::Absolute));
    brushPattern.add(BrushPoint(0, 1, 0.05, PointType::Absolute));
    brushPattern.add(BrushPoint(1, 1, 0.025, PointType::Absolute));
    brushPattern.add(BrushPoint(1, 0, 0.05, PointType::Absolute));
    brushPattern.add(BrushPoint(1, -1, 0.025, PointType::Absolute));
    brushPattern.add(BrushPoint(0, -1, 0.05, PointType::Absolute));
